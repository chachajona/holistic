...
const Hero: React.FC<HeroProps> = ({ formData }) => {
    ...
    return (
        <section className="bg-hero-pattern relative max-h-screen min-h-[calc(100dvh-92px)] w-full overflow-y-auto bg-cover bg-center py-16 md:min-h-[calc(100dvh-250px)] md:py-[85px]">
