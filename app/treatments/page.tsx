        ...
        <div className="bg-primary-background relative w-full py-16 sm:px-16">
            <div className="text-primary-text relative z-10 mx-auto flex max-w-3xl flex-col items-center justify-center text-center">
                ...
                <p className="font-robotoSlab text-primary-text/50 mb-8 max-w-xl p-1 font-normal">
                    Các phương pháp điều trị vật lý trị trị liệu của chúng tôi
                    bao gồm một lọa các giải pháp để đáp ứng nhu cầu riêng của
                    bạn. Từ liệu pháp thủ công đến điện châm, chúng tôi sẽ giúp
                    bạn tạo ra một phương pháp điều trị cá nhân hóa để giúp bạn
                    đạt được sự phục hồi tối ưu.
                </p>
            </div>
